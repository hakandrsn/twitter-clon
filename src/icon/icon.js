...
export const NotificationIcon = () => { //okey
    return (
        <Svg className="w-7 h-7">
...
export const BookmarksIcon = () => {//okey
    return (
        <Svg className="w-7 h-7">
...
export const ImageIcon = ({ className }) => { //okeyy
    return (
...
export const GifIcon = ({ className }) => {//okey
    return (
        <Svg className={className}>
...
export const EmojiIcon = ({ className }) => {//okey
    return (
        <Svg className={className}>
...
export const ScheduleIcon = ({ className }) => {//okey
    return (
        <Svg className={className}>
...
export const PopulerIcon = ({ className }) => { //okey
    return (
        <Svg className={className}>
...
export const ReplyIcon = ({ className }) => {//okey
    return (
        <Svg className={className}>
...
export const RetWeetIcon = ({ className }) => {  //okey
    return (
        <Svg className={className}>
...
export const LikeIcon = ({ className }) => {  //okey
    return (
        <Svg className={className}>
...
export const ShareIcon = ({ className }) => {  //okey
    return (
        <Svg className={className}>
...
export const SearchIcon = ({ className }) => {  //okey
    return (
        <Svg className={className}>
